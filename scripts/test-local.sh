...
echo -e "${GREEN}========================================${NC}"
echo -e "${GREEN}Order Service Local Build & Test${NC}"
echo -e "${GREEN}========================================${NC}"
echo ""
...
echo -e "${GREEN}[4/6]${NC} Starting order-service container..."
...
docker run -d \
  ...
  -e DB_HOST=order-mariadb \
  -e DB_PORT=3306 \
  -e DB_NAME=commerce-order \
  -e DB_USERNAME=admin \
