package com.koosco.orderservice.order.api.controller

import com.koosco.common.core.response.ApiResponse
import com.koosco.commonsecurity.resolver.AuthId
import com.koosco.orderservice.order.api.request.CreateOrderRequest
import com.koosco.orderservice.order.api.request.RefundOrderItemsRequest
import com.koosco.orderservice.order.api.response.CreateOrderResponse
import com.koosco.orderservice.order.api.response.OrderDetailResponse
import com.koosco.orderservice.order.api.response.OrderResponse
import com.koosco.orderservice.order.api.response.RefundResponse
...
class OrderController(
    ...
    fun getOrders(
        ...
        return ApiResponse.success(result.map { OrderResponse.from(it) })
    }
    ...
    fun refundOrderItems(
        ...
        return ApiResponse.success(RefundResponse.from(result))
    }
}
